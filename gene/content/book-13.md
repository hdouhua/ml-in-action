...
这就是神话的力量——它能及时采取一个或一系列的事件，并让它们永恒存在。所谓同理，就是深入核心，让所有的伟大神诂绽放。但比起神话，同理霄其实更为深远，因为同理能让对立重新结合，为故事带来结局。同理是超越时间的意识状态，虽然其实它也包含了时间。同样的，数字13是奥秘的象征，它是以12为架构的巨轮的中心枢纽，是圆桌中心的那个圣杯的神秘数字，或是被12个门徒包围的耶稣。 13是阿拉克妮（Arachne）[^arachne]的数字，是「蜘蛛」这个黄道12星座之外的第13个神秘象征。她就位于创作之网的核心，透过她的脚，维持和所有事物的持续同理心。
